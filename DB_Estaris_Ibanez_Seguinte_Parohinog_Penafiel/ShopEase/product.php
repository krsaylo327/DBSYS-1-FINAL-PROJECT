        ...
        <section class="product-detail">
            <div class="product-gallery">
                ...
                <div class="gallery-images">
                    <label for="img1"><img src="https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80" alt="Product 1"></label>
                    <label for="img2"><img src="https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=400&q=80" alt="Product 2"></label>
                    <label for="img3"><img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80" alt="Product 3"></label>
                </div>
                <div class="main-image">
                    <img src="https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=600&q=80" alt="Product Main">
                </div>
            </div>
            <div class="product-info">
                <h2>Smartphone X200</h2>
                <p class="price">₱499</p>
                <p class="desc">Experience the next generation of mobile technology with the X200. Sleek design, powerful performance, and a stunning display.</p>
                <div class="swatches">
                    <span class="swatch color1" title="Black"></span>
                    <span class="swatch color2" title="Silver"></span>
                    <span class="swatch color3" title="Blue"></span>
                </div>
                <div class="swatches size">
                    <span class="swatch">64GB</span>
                    <span class="swatch">128GB</span>
                    <span class="swatch">256GB</span>
                </div>
