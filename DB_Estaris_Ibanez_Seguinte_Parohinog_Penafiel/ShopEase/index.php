...
<head>
    ...
    <title>ShopEase - Modern E-Commerce Demo</title>
    ...
    <main>
        <section class="hero">
            <div class="hero-content">
                ...
                <p>Up to <span class="highlight">50% OFF</span> on select items. Shop the latest trends in electronics, fashion, and more.</p>
                <a href="catalog.html" class="cta-btn">Shop Now</a>
            </div>
            <div class="hero-img">
                <img src="https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=600&q=80" alt="Summer Sale">
            </div>
        </section>
        <section class="featured-products">
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <img src="https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80" alt="Smartphone">
                    <h3>Smartphone X200</h3>
                    <p class="price">₱499</p>
                    <a href="product.php" class="details-btn">View Details</a>
                </div>
                <div class="product-card">
                    <span class="badge sale">Sale</span>
                    <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80" alt="Headphones">
                    <h3>Noise Cancelling Headphones</h3>
                    <p class="price">₱199</p>
                    <a href="product.php" class="details-btn">View Details</a>
                </div>
                <div class="product-card">
                    <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80" alt="Sneakers">
                    <h3>Classic Sneakers</h3>
                    <p class="price">₱89</p>
                    <a href="product.php" class="details-btn">View Details</a>
                </div>
                <div class="product-card">
                    <img src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=400&q=80" alt="Backpack">
